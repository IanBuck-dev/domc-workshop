...
| [ai-runtime.md](ai-runtime.md)                                     | How the selected AI CLI is called: bounded operations, versioned prompts, validation, sandbox, progress events |
...
| AI runtime      | `packages/ai-runtime/src`, `packages/claude/src` | Provider-neutral contracts, Codex default, Claude compatibility adapter, bounded calls and validation |
