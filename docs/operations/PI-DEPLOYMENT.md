...
ssh ian_claw@pi-controller.tailb3f4a9.ts.net \
  'sudo -u claims-ai env HOME=/var/lib/claims-ai PATH=/opt/claims-ai-codex/bin:/var/lib/claims-ai/.bun/bin:/usr/local/bin:/usr/bin:/bin codex login status'
```
...
ssh -t ian_claw@pi-controller.tailb3f4a9.ts.net \
  'sudo -u claims-ai env HOME=/var/lib/claims-ai PATH=/opt/claims-ai-codex/bin:/var/lib/claims-ai/.bun/bin:/usr/local/bin:/usr/bin:/bin codex login'
```
